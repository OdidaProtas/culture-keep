...
{#if !isAdm}
	<div class="p-3 bg-red-200 text-lg rounded-3xl lg:mx-48 text-center ">
		<p>Unauthorized. You must be logged in with an administrator account to view this page</p>
