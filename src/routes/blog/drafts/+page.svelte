...
{#if !user}
	<div class="text-center text-lg mt-9 bg-red-200 outline outline-red-400 p-2 rounded-lg ">
		<p>Unauthorized! You must be signed in to view this page</p>
		<p class="mt-9"><a href="/auth/signin">Sign in to your account</a></p>
	</div>
{/if}

{#if user && !isAdmin(user?.email)}
	<div class="text-center text-lg mt-9 bg-red-200 outline outline-red-400 p-2 rounded-lg ">
		<p>Unauthorized! You must have an administrator account to view this page.</p>
		<p class="mt-9"><a href="/auth/signin">Sign in with admin account</a></p>
	</div>
{/if}
